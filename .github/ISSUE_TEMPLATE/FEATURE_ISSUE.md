...
about: Want us to add any features to antibars-bot?
title: 'enh: '
labels: enhancement
assignees: ''
...
<!--
  Hi! Thanks for considering to file a feature request with antibars-bot. Please take the time to
...
<!--
  Why do you want to see this feature in antibars-bot? What use cases does it support?
-->
